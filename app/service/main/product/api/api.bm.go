...
This code was generated with punk/tool/protobuf/protoc-gen-bm v0.1.
...
var PathDemoSayHelloURL = "/punk-demo/say_hello"
...
func RegisterDemoBMServer(e *bm.Engine, server DemoBMServer) {
	...
	e.GET("/punk-demo/say_hello", demoSayHelloURL)
}
