...
import (
	...
	"angrymiao-go/app/service/main/dapper/internal/dao"
	"angrymiao-go/app/service/main/dapper/internal/model"
	"angrymiao-go/app/service/main/dapper/internal/pkg/batchwrite"
	"angrymiao-go/app/service/main/dapper/internal/pkg/collector"
	"angrymiao-go/app/service/main/dapper/internal/pkg/collector/kafkacollect"
	"angrymiao-go/app/service/main/dapper/internal/pkg/collector/tcpcollect"
...
type Collector struct {
	...
	process []Processer
	clts    []collector.Collector
	tcpClt  *tcpcollector.TCPCollect
}
...
func (c *Collector) ListenAndStart() error {
	tcpClt := tcpcollector.New(c.cfg.Collect)
	...
	if c.cfg.KafkaCollect != nil {
		kafkaClt, err := kafkacollector.New(c.cfg.KafkaCollect.Topic, c.cfg.KafkaCollect.Addrs)
		if err != nil {
			return err
		}
